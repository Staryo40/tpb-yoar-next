...
function Homepage () {
    return (
        ...
        <NavBar />
        <div className={indexStyles.homeBody}>
            <div className={indexStyles.welcome}>
                <img src={WelcomeBG.src} alt="itb danau kampus jatinangor" />
                <div className={indexStyles.textContainer}>
                    <h1 className={`${indexStyles.textWelcome} ${indexStyles.title}`}>Welcome To TPB Yoar!</h1>
                    <span className={`${indexStyles.textWelcome} ${indexStyles.explain}`}>Archive dan referensi belajar TPB ITB</span>
                </div>
            </div>
            <div className={indexStyles.homeContent}>
                ...
                <div className={indexStyles.module}>
